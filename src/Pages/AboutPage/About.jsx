    ...
    <div className="hero min-h-screen max-w-[90vw] mx-auto my-10">
      <div className="hero-content flex-col lg:flex-row flex-col-reverse">
        <div className="lg:w-1/2 lg:mt-0 lg:text-left w-10/12">
          <div className="lg:w-4/5 space-y-4">
            ...
            <h5 className=" text-4xl md:text-5xl font-bold text-[#151515]">
              Best services and the experience of unique holidays
            </h5>
            <p className="py-4 text-base font-normal text-[#737373]">
              One of the best services for unique holidays is{" "}
              <strong>Green Villa</strong> hotel planning.{" "}
              <strong>Green Villa</strong> tailored to your specific desires
              take into account your interests, budget, and preferred
              destinations, ensuring that every aspect of your trip is
              personalized.
            </p>
        ...
        <div className="relative ml-14">
          <img
            data-aos="fade-right"
            src="https://i.ibb.co/M2nLPCG/home-2.jpg"
            className="lg:w-full rounded-lg shadow-2xl"
          />
          <img
            data-aos="fade-left"
            src="https://i.ibb.co/7vzTPqM/home-1.jpg"
