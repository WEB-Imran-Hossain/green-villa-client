...
const Navbar = () => {
    ...
    return (
        <div className="navbar bg-base-100 sticky top-0 z-10 flex justify-around items-center">
            ...
            <div className="">
{
    ...
    <div className="dropdown dropdown-end">
                    ...
                    <ul tabIndex={0} className="mt-3 z-[1] p-2 shadow menu menu-sm dropdown-content bg-base-100 rounded-box w-52 text-lg font-semibold">
                        <li>
