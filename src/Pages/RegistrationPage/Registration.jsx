            ...
            <div className="hero-content flex-col lg:flex-row">
                <div className="card flex-shrink-0 shadow-2xl bg-base-100 p-5 rounded-none">
                    ...
                    <div className="card-body">
                        ...
                        <p className="text-base font-normal text-[#737373]">Already have an account yet? <Link to="/login"><span className='text-base font-normal text-[#32CD32]'>Log In</span></Link></p>
                        <form onSubmit={handleSignUp}>
                            ...
                            <div className="form-control mt-6">
                                <input className='btn text-white bg-[#FF3811] border-[#FF3811]  hover:border-[#32CD32] hover:text-[#32CD32] text-lg font-semibold rounded-none normal-case hover:bg-transparent ' type="submit" value="Sign Up" />
                            </div>
                            ...
                            <div>
                                ...
                                <label className="ml-2 label-text font-bold" htmlFor="terms">
                                    Yes, I agree with <a href=""><Link className="link link-hover" href="#">Terms of Use Conditions</Link></a>
                                </label>
                            </div>
                            <br />
