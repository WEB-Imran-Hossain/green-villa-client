  ...
  return (
    <div className=" max-w-[90vw] mx-auto space-y-4 space-y-4 mt-32">
      ...
      <div className="">
        ...
        <div className="card card-side bg-base-100 shadow-xl flex-row-reverse rounded-none hover:bg-gradient-to-r from-[#32CD32] to-[rgba(21, 21, 21, 0.8)] flex flex-col lg:flex-row-reverse">
          <figure>
